        ...
        <>
            <TransferContainer>
                <TransferForm id="transactionForm" onSubmit={handleSubmit}>
                    <TransferReceived onClick={() => setShowDropdown(prevState => !prevState)}>
                        <Input value={received.value || selectedItem} onChange={received.onChange} type="text" id="received" name="received" placeholder="Received Account" />
                        <DropdownArrow size="1.3rem" flip={!showDropdown} />
                        {(savedAccounts && showDropdown) && <Dropdown items={savedAccounts} setSelectedItem={setSelectedItem} />}
                    </TransferReceived>
                    <TransferAmount>
                    ...
                    <Button icon="solar:card-transfer-bold-duotone" type="submit">Send</Button>
                </TransferForm>
            </TransferContainer>
